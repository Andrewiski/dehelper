...
export class UserStoreFile extends UserStore implements iUserStore {
  ...
  constructor(userStoreFileOptions: UserStoreFileOptions | undefined) {
    super(userStoreFileOptions);
    if (this.userStoreFileOptions === undefined) {
      this.userStoreFileOptions = this.defaultUserStoreFileOptions;
      this.userStoreFileOptions.accessTokenExpiresIn =
        this.defaultUserStoreOptions.accessTokenExpiresIn;
      this.userStoreFileOptions.refreshTokenExpiresIn =
        this.defaultUserStoreOptions.refreshTokenExpiresIn;
      this.userStoreFileOptions.defaultHashOptions =
        this.defaultUserStoreOptions.defaultHashOptions;
    }
    if (userStoreFileOptions !== undefined) {
      this.userStoreFileOptions.dataPath =
        userStoreFileOptions.dataPath ||
        this.defaultUserStoreFileOptions.dataPath;
      this.userStoreFileOptions.memoryOnly =
        userStoreFileOptions.memoryOnly ||
        this.defaultUserStoreFileOptions.memoryOnly;
      this.userStoreFileOptions.accessTokenExpiresIn =
        userStoreFileOptions.accessTokenExpiresIn ||
        this.defaultUserStoreOptions.accessTokenExpiresIn;
      this.userStoreFileOptions.refreshTokenExpiresIn =
        userStoreFileOptions.refreshTokenExpiresIn ||
        this.defaultUserStoreOptions.refreshTokenExpiresIn;
      this.userStoreFileOptions.defaultHashOptions =
        userStoreFileOptions.defaultHashOptions ||
        this.defaultUserStoreOptions.defaultHashOptions;
    }
